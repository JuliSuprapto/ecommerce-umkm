...
//    private void checkoutDataKeranjang(String id) {
//        HashMap<String, String> params = new HashMap<String, String>();
//        params.put("status", "1");
//
//        final JsonObjectRequest req = new JsonObjectRequest(Request.Method.PUT, BaseURL.checkoutDataPesanan + id, new JSONObject(params),
//                new Response.Listener<JSONObject>() {
//                    @Override
//                    public void onResponse(JSONObject response) {
//                        System.out.println("response = " + response);
...
//                            if (status == true) {
//                                StyleableToast.makeText(context, "Data berhasil checkout", R.style.toastStyleSuccess).show();
//                                context.startActivity(new Intent(context, MainPembeli.class).putExtra("_id", "2131230980"));
////                                Intent i = new Intent(context.getApplicationContext(), KeranjangPembeliFragment.class).setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
////                                context.getApplicationContext().startActivity(i);
////                                FragmentManager fragmentManager = ((AppCompatActivity) context).getSupportFragmentManager();
////                                KeranjangPembeliFragment keranjangFragment = new KeranjangPembeliFragment();
////                                fragmentManager.beginTransaction().replace(R.id.nav_view, keranjangFragment).commit();
//                            }
//                        } catch (JSONException e) {
//                            e.printStackTrace();
//                        }
