...
public class AccountFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        updateProfileData = (LinearLayout)v.findViewById(R.id.update_profile);
        ...
        String namaPedagang = modelUsers.getNama();

        ((AppCompatActivity) getActivity()).getSupportActionBar().setTitle(namaPedagang);
